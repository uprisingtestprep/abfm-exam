/* ABFM Exam Simulator — Application Logic */

const ACCESS_CODE  = "ABFM9000";
const EXAM_SECONDS = 22680;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "abfm_exam_state_v1";
const SIM_Q_COUNT  = 300;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"acute_care_and_diagnosis": "Acute Care and Diagnosis", "chronic_care_management": "Chronic Care Management", "emergent_and_urgent_care": "Emergent and Urgent Care", "preventive_care": "Preventive Care", "foundations_of_care": "Foundations of Care"};  // maps domain key -> human-readable label for display
